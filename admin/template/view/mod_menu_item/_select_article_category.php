...
<?php
        ...
        if (sizeof($category->slaves['ArticleCategory']) > 0) {
            $level++;
            showCategoryList($category->slaves['ArticleCategory'], $type_text, $level);
            $level--;
        }
    }
}
...
function on_quick_add_cate_a_success(response) {
    ...
    var stat = document.getElementById("adminmis_cate_a_stat");
...
<!--div class="content_toolbar">
	<table cellspacing="0" class="wrap_table">
		<tbody>
			<tr>
				<td><div class="title"><?php  //_e('Please select article category to list'); ?></div></td>
			</tr>
		</tbody>
	</table>
</div-->
...
<div class="status_bar">
	<span id="adminmis_cate_a_stat" class="status" style="display:none;"></span>
</div>
<!--table cellspacing="0" class="form_table">
    <tbody>
        <tr>
            ...
            <?php
            //echo Html::select('parent_cate_a', 
                //$select_categories);
            ?>
            </td>
            <td class="entry" width="140"><?php //echo Html::input('text', 'new_cate_a'); ?></td>
            <td class="entry" width="100"><a href="#" onclick="add_cate_a(); return false;"><?php //_e('Add Category'); ?></a></td>
            <td></td>
        </tr>
    </tbody>
</table-->
<!--div class="space"></div-->
<table cellspacing="0" class="list_table" id="admin_category_a_list">
	<thead>
		<tr>
			<th width="20"></th>
            <th><?php _e('Article Categories'); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <tbody>
        <tr class="row_style_0">
			<td></td>
        	<td class="left"><?php _e('All Articles'); ?></td>
        	<td>
        	       <a href="#" onclick="select_for_menu_item('<?php echo $type_text.' - '.__('All Articles'); ?>', '0'); return false;"><?php _e('Select'); ?></a>
        	</td>
        </tr>
